...
class HomeViewModel() : BaseViewModel() {
    ...
    private val bannerData by lazy { MutableLiveData<List<Banner>>() }


    fun getBanner():MutableLiveData<List<Banner>>{
        launchUI {
    ...
    private var _articleData= MutableLiveData<PagingData<ArticleData>>()

//    val article get() =_articleData

    fun getArticle():MutableLiveData<PagingData<ArticleData>> {
         launchUI {
