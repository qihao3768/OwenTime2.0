...
class RecommendFragment : BaseFragment(R.layout.recommend_fragment) {
    ...
    private val mBinding by viewBinding(RecommendFragmentBinding::bind)
    ...
    private fun initBanner() {
        viewModel.getBanner().observe(this) { it ->
            it?.run {
                ...
                mBinding.homeBanner.addBannerLifecycleObserver(this@RecommendFragment).setAdapter(
